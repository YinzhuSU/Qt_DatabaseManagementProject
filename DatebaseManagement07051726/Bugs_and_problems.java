public class Bugs_and_problems {
    main.cpp                  ///9//能否把处理语言的操作放到选择语言的欢迎界面里进行？但是这个a.installTranslator(&t);里的a好像只有在main.cpp这里才有
    ...
    SQLite Database:          //如何创建trigger？为什么总是失败？
                              //提示的是：[10:28:32] Error while executing SQL query on database 'test1': cannot commit - no transaction is active
}
