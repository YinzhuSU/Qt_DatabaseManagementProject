...
#include "../../DatebaseManagement/loginwidget.h"
...
QT_MOC_LITERAL(1, 12, 18), // "returnButtonSignal"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 19) // "on_btnLogin_clicked"

    },
    "LoginWidget\0returnButtonSignal\0\0"
    "on_btnLogin_clicked"
};
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->returnButtonSignal(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::returnButtonSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginWidget::returnButtonSignal()
{
